...
| 4 | [Seden Özcan](https://github.com/sednozcan) | [ResearchPilot](https://github.com/sednozcan/research-pilot) | Python, FastAPI, React, Gemini API |Kullanıcı sorusunu analiz ederek araştırma planı oluşturan ve Gemini API ile yapılandırılmış araştırma raporu üreten AI agent. |
