...
| 4 | [Doğa Güneş](https://github.com/doagunes) | [csv-analyst-agent](https://github.com/doagunes/csv-analyst-agent) | Python, Ollama | CSV verisiyle doğal dilde konuşan, tamamen yerel (Ollama + llama3.1) çalışan analiz agent'ı. |
